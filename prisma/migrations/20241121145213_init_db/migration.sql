...
-- CreateEnum
CREATE TYPE "TransactionPaymentsMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'BANK_SLIP', 'CASH', 'PIX', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "paymentsMethod" "TransactionPaymentsMethod" NOT NULL,
